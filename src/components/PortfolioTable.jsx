...
// 								SL No.
// 							</th>
// 							<th className="text-left py-3  w-[23%] px-4 text-[14px]">
// 								Title
// 							</th>
// 							<th className="text-left py-3 px-4 text-[14px]">
// 								Client Code URL
...
// 									{item.title}
// 								</td>
// 								<td className="py-3 px-4 text-[13px] text-center mx-auto justify-center">
// 									<span
// 										className="text-blue-500 font-semibold hover:underline cursor-pointer"
// 										onClick={() =>
// 											openLink(item.clientGithub)
...
// 									{item.live_link}
// 								</td>
// 								<td className="py-3 px-4 text-[14px] mx-auto">
