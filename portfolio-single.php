    ...
    <body class="theme-bg">
        ...
        <main>
            <?php 
                ...
                $port_query_output = mysqli_query($db_conn, $port_query);
                $portfolio = mysqli_fetch_assoc($port_query_output);
            ?>
            <!-- breadcrumb-area -->
                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="single-blog-list">
                                <div class="blog-list-thumb mb-35">
                                    <img src="views/backend/upload/portfolio_img/<?=$portfolio['port_photo']?>" alt="img">
                                </div>
                                <div class="blog-list-content blog-details-content portfolio-details-content" >
                                    <div>
                                        <?=$portfolio['port_details']?>
                                    </div>
                                        <?=$portfolio['port_photo']?>
